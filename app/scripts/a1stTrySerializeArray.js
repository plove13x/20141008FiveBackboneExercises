...
App.Views.BlogPostAppRouter = Backbone.Router.extend ({			/* So would you never have changed application state yesterday for this - just svaed a model? I thought clearing the form would count */
	routes: {
		"submit": 'postBlogPost'
	},
